...
public class MainActivity extends Activity
{
	...
	{
		Log.d(TAG, "=========================in testReturnString function==============" + param + "," + p2 + "," + p3 + "," + p4);
		return "9999999";
	...
	{
		Log.d(TAG, "=========================in testReturnInt function==============" + param + "," + p2 + "," + p3 + "," + p4);
		return 999;
	...
	{
		Log.d(TAG, "=========================in testReturnDouble function==============" + param + "," + p2 + "," + p3 + "," + p4);
		return 7777.0;
	...
	{
		Log.d(TAG, "=========================in testReturnFloat function==============" + param + "," + p2 + "," + p3 + "," + p4);
		return 7777.0f;
